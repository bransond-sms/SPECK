...
1. Download the [standalone install bundle](https://github.com/bransond-sms/SPECK/releases/latest/download/SPECK_Standalone_Install.zip) and extract it wherever you want the launch shortcut to appear. (Alternatively, click **Code → Download ZIP** on the [SPECK GitHub page](https://github.com/bransond-sms/SPECK) — same contents.)
